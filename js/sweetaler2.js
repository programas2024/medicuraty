        ...
        html: `
            <div style="text-align: center; padding: 5px; max-height: ${isMobile ? '70vh' : '500px'}; overflow-y: auto; scrollbar-width: none;">
                ...
                <div class="popup-seccion-clara" style="background: linear-gradient(145deg, #fbc1d0, #ffd9e3); padding: ${isMobile ? '15px' : '25px'}; border-radius: ${isMobile ? '40px' : '80px'}; margin: 10px 0;">
                    ...
                    <div style="display: flex; gap: 8px; justify-content: center; flex-wrap: wrap;">
                        ${['DANIEL ARBOLEDA', 'HERNEY BENAVIDEZ', 'ANGIE RODRÍGUEZ', 'VICTORIA MANRIQUE', 'ANDRÉS TORO', 'ANGELA ROMERO', 'NICOLAS GUTIERREZ', 'MILAGROS RAMIREZ', 'ALLISON ROMERO', 'NELLY MARIN','KATERINE MARTINEZ A '].map(nombre => 
